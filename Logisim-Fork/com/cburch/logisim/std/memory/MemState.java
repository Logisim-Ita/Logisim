...
class MemState implements InstanceData, Cloneable, HexModelListener {
	...
	private static final int TABLE_WIDTH12 = 80; // width of table for addr bits
													// <= 12
	private static final int TABLE_WIDTH32 = 65; // width of table for addr bits
													// > 12

	private static final int ENTRY_HEIGHT = 15; // pixels high per entry

	private static final int ENTRY_XOFFS12 = 40; // x offset for entries for
													// addr bits <= 12
	private static final int ENTRY_XOFFS32 = 60; // x offset for entries for
													// addr bits > 12

	private static final int ENTRY_YOFFS = 5; // y offset for entries

	private static final int ADDR_WIDTH_PER_CHAR = 10; // pixels wide per
														// address character
